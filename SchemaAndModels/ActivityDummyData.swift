...
extension Activity {
    static private var dummyActivities: [Activity]?
    static func getDummyActivities() -> [Activity] {
        if dummyActivities == nil{
            ...
            activity4.name = "always"
            activity4.detail = "but part of parent"
            activity4.timeToComplete = 60 * 5 // 5 minutes
            activity4.onOffTimes?.append(contentsOf: [
                TimeRange(
                    start: Date(),
            ...
            dummyActivities = [activity1, activity2, activity3]
        }
        return dummyActivities!
    }
    
    static private var swissBurgerRecepie: [Activity]?
    static func getSwissBurgerRecepie() -> [Activity]{
